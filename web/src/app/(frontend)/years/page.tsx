...
export default function YearsPage() {
  ...
  return (
    <main className="page page--inner page--years">
      <Hero
        image="oa-01"
        kicker="Архив"
        title="Как это было"
        subtitle="Летопись карнавала по годам"
        decor="chronicle"
      />
      ...
      <div className="wrap page-shell">
        ...
        <section className="section section--tight">
          <p className="lead">
            У карнавального шествия каждый год — своя тема. Костюмы не повторяются, делегации готовятся месяцами, а
            Король и Королева карнавала возглавляют колонну. Вот летопись, которую удалось восстановить по репортажам,
            архивам и пабликам района — у годов со стрелкой есть отдельная страница с подробностями и фотографиями.
          </p>
          ...
          <div className="notice">
            Помните темы 2017–2021 годов, сохранились афиши или фотографии? Напишите оргкомитету или в паблики района —
            поможем собрать полную летопись ярмарки.
          </div>
        </section>
      </div>
    </main>
