      ...
      <div className="wrap page-shell">
        ...
        <section className="section section--tight">
          ...
          <figure className="poster">
            ...
            />
            <figcaption>
              {/* Афиша — яркий официальный документ; без пометки её легко принять за действующую */}
              {FEST_CANCELLED ? 'Официальная афиша 2026 года — праздник отменён, афиша не действует' : 'Официальная афиша праздника'}{' '}
              ·{' '}
