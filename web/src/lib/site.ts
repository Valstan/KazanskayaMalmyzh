...
export const YEAR_THEMES: { year: number; date?: string; theme: string; note?: string; weak?: boolean }[] = [
  ...
  { year: 2025, date: '19 июля', theme: 'Ярмарка собрала лучших мастеров', note: 'тема шествия уточняется' },
  { year: 2024, date: '20 июля', theme: 'Ах, карнавал — удивительный мир!', note: 'гран-при шествия — д/с №2 «Полянка»; дождливый, но яркий карнавал' },
  { year: 2023, date: '22 июля', theme: 'ЧУДный карнавал', note: 'тема шествия по постам РЦКД' },
  { year: 2022, date: '23 июля', theme: 'Малмыж не Париж, а карнавал есть', note: 'лозунг карнавального шествия' },
