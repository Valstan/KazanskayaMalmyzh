...
// Та же дата в предложном падеже. Именительный годится только там, где дата
// стоит отдельной репликой («суббота, 25 июля 2026 · г. Малмыж»); внутри
// фразы он даёт «Ярмарка суббота, 25 июля 2026 не состоялась». Падеж —
// свойство языка, а не вёрстки, поэтому живёт рядом с самой датой: назначат
// новую — правятся обе строки разом и рассинхрона не будет.
export const FEST_DATE_HUMAN_PREP = 'в субботу, 25 июля 2026 года'
