...
export const IMAGE_CREDITS: ImageCredit[] = [
  ...
  },
  {
    ...
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Берег_Вятки_-_panoramio.jpg',
    usage: 'Главная — берег Вятки в Малмыжском районе',
  },
  {
    slug: 'kurya-backwater',
    title: 'Затон Курья',
    author: 'Sexy Sadie',
    license: 'CC BY 3.0',
    licenseUrl: 'https://creativecommons.org/licenses/by/3.0',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Затон_Курья_-_panoramio.jpg',
    usage: 'Главная — природа Малмыжского района и фон финального блока',
  },
  {
    slug: 'mitrofanovskaya-church',
    title: 'Малмыж, Митрофановская церковь',
    author: 'Ele-chudinovsk',
    license: 'CC BY-SA 4.0',
    licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0',
    sourceUrl: 'https://commons.wikimedia.org/wiki/File:Малмыж,_Митрофановская_церковь.jpg',
    usage: 'Главная — архитектура и достопримечательности Малмыжа',
  },
]
